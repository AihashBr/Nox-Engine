    ...
    for (const folderName in folders) {
      ...
      <div style="margin-top: 10px;">
        <div style="display: flex; align-items: center; margin-left: 5px;">
          ...
          <button class="btn-folder" onclick="loadFiles({rootFolder: '${rootFolder}', folderName: '${folderName}'})">${folderName}</button>
          <button class="btn-gray" style="width: 25px; height: 25px; margin-left: 5px;" onclick="createFile({folderName: '${folderName}'})">+</button>
        ...
        <div id="files-${folderName}" style="margin-left: 25px;"></div>
      </div>`;
    }
  }
